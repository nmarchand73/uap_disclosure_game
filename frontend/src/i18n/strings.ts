...
export const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    variant_investigation: "Investigation",
    variant_terrain: "Terrain",
    variant_military: "Military",
    variant_civil: "Civil",
    variant_mufon: "MUFON Researcher",
    variant_ex_agent: "Ex-Government Agent",
    variant_visual: "Visual Witness",
    variant_contact: "Contact",
    variant_classic: "Classic (1970–1989)",
    variant_modern: "Modern (Post-2000)",
    variant_rural: "Rural Sheriff",
    variant_urban: "Urban Officer",
    newGame: "New game",
    joinGame: "Join game",
    ...
    mode: "Mode",
    modeSolo: "Competitive (Solo)",
    modeCoop: "Cooperative",
    useSkill: "Use skill (+1 token)",
    copy: "Copy",
    copied: "Copied!",
    questionXofY: "Question %1/%2",
    specialWhistleblower: "Whistleblower! +1 token (any authority).",
    specialMIB: "Men in Black — you skip your next turn.",
    specialHoax: "Hoax — one event card replaced.",
    specialMassSighting: "Mass Sighting — all on this continent +1 token.",
    turnSkipped: "Turn skipped.",
    drewEventCard: "Drew a new event card.",
    youMovedTo: "You moved to",
    position: "Position",
    steps: "steps",
  },
  fr: {
    ...
    variant_investigation: "Investigation",
    variant_terrain: "Terrain",
    variant_military: "Militaire",
    variant_civil: "Civil",
    variant_mufon: "Chercheur MUFON",
    variant_ex_agent: "Ex-agent gouvernemental",
    variant_visual: "Témoin visuel",
    variant_contact: "Contact",
    variant_classic: "Classique (1970–1989)",
    variant_modern: "Moderne (post-2000)",
    variant_rural: "Shérif rural",
    variant_urban: "Officier urbain",
    ...
    mode: "Mode",
    modeSolo: "Compétitif (Solo)",
    modeCoop: "Coopératif",
    useSkill: "Utiliser compétence (+1 jeton)",
    copy: "Copier",
    copied: "Copié !",
    questionXofY: "Question %1/%2",
    specialWhistleblower: "Lanceur d'alerte ! +1 jeton (autorité au choix).",
    specialMIB: "Men in Black — vous passez votre prochain tour.",
    specialHoax: "Canular — une carte événement remplacée.",
    specialMassSighting: "Observation massive — tous sur ce continent +1 jeton.",
    turnSkipped: "Tour passé.",
    drewEventCard: "Une nouvelle carte événement piochée.",
    youMovedTo: "Vous avez avancé vers",
    position: "Position",
    steps: "cases",
  },
};
